...
const RippleCard = () => {
  ...
  return (
    <div
      ...
      className="card relative mt-4 h-[15rem] w-[30rem]  overflow-hidden rounded-md border border-white bg-gradient-to-tr from-graphite to-blue font-bold text-black"
    >
