        ...
        return (
          ...
          >
            ...
            <img
              src={item.img_url}
              alt={item.title}
              className={`absolute bottom-0 max-h-[122.3px] w-[135px] sm:max-h-[165px] sm:w-[182px] md:max-h-[158px] md:w-[159px] xl:max-h-[190px] xl:w-[179px] 3xl:w-[192px] 5xl:max-h-[257px] 5xl:w-[266px] ${index % 2 === 0 ? "bottom-0 left-0" : "bottom-0 right-0"}`}
            />
